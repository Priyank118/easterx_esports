...
// We no longer need the useScrollReveal hook in this component
...
const HighlightsSection = ({ onNavLinkClick }) => {
    ...
    // We also remove the instance of the hook
        ...
        <Section id="highlights" title="BGMI Tournaments & Features">
            <div className="card-grid">
                {highlightsData.map((item, index) => (
                    ...
                    // ref, className, and style for animation are removed from this div
                    <div
                        key={index}
                        className="card"
                    >
                        <img
                            ...
                            alt={item.alt}
                            className="icon"
                            // I've adjusted the icon size back to a more standard size
